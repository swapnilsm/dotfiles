...
;; (setq doom-variable-pitch-font (font-spec :family "JetBrains Mono NL" :size 15 :weight 'regular))
...
** AUTO TANGLE
This is not required anymore as doom provides config/literate module.
#+BEGIN_SRC elisp
