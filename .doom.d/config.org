...
(defun swapnilsm/sync-calendar ()
  ...
  (let* ((command "cd ~/Projects/python-samples/calendar/quickstart && ~/Projects/python-samples/calendar/quickstart/calendar/bin/python3 ~/Projects/python-samples/calendar/quickstart/q.py")
    ...
    (set-process-sentinel process (lambda (_ _) (message "Syncing calendar... Done.")))))
#+end_src
...
;;           (medium
;;            :default-height 190
;;            :fixed-pitch-height 190
;;            :variable-pitch-height 200)
;;           (large
;;            :default-height 210
;;            :fixed-pitch-height 210
;;            :variable-pitch-height 230)
;;           (presentation
